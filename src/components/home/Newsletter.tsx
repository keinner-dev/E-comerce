export const Newsletter = () => {
  return <div className="relative py-20 text-white bg-gray-500">
    {/* IMAGEN DE FONDO */}
    ...
    <div className="container relative z-10 p-5 md:p-0">
        <div className="w-full text-black bg-white p-12 space-y-5 md:w-[50%] lg:w-[40%]">
            ...
            <form className="flex flex-col gap-5 xl:flex-row">
                <input type="email" className="w-full px-5 py-3 font-medium border rounded-full border-slate-200 focus:outline-none text-sx" 
